# ============================================================
# MASTERMIND v33.0 - "ORBITAL DOMINANCE"
# ============================================================
# Based on v31 with focused improvements:
#   1. REVENGE WINDOW: Increased from 25 to 35 turns.
#   2. ORBITAL BOOST: Increased inner-orbit multiplier to 2.0.
#   3. NEUTRAL AGGRESSION: Neutral multiplier increased to 6.0.
#   4. COMET PRIORITY: Comet multiplier increased to 15.0.
#   5. DISPATCH LIMIT: 3 dispatches per planet (vs 2 in v31).
#   6. FFA FOCUS: Increased leader targeting multiplier.
# ============================================================
...
def agent(obs):
    ...
    for mp in my_p:
        ...
        if step < 5: print(f"DEBUG: Step {step} Planet {mp['id']} avail {avail}")
