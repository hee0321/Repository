    ...
    for mp in my_planets:
        ...
        for tp in other_planets:
            ...
            if score > best_score:
                ...
                best_target = tp
                best_angle = angle
                # ALWAYS SEND ALL AVAILABLE SHIPS to maximize speed, except if we have overwhelmingly more
                # than needed, then maybe save some for another dispatch? No, send all.
