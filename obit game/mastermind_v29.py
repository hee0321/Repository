# ============================================================
# MASTERMIND v29.1 NEBULA "The Restoration Final"
# ============================================================
# PERFORMANCE RECOVERY:
#   1. RESTORES V18 MULTIPLIERS: High neutral focus but balanced.
#   2. RESTORES V18 DISPATCH: Aggressive all-in for priority targets.
#   3. KEEPS 40-STEP PROJECTION: Precision threat detection.
#   4. KEEPS WAYPOINTS: Essential for sun survival.
#   5. REVENGE (Slight): 3x priority for recapturing lost territory.
# ============================================================
            ...
            while avail > 5 and dispatches < 2:
                ...
                for tp in all_p:
                    ...
                    if tp['owner'] == player:
                        ...
                        if tp['owner'] == -1: score *= 4.5 # Slightly higher than v18
                        if tp['is_comet']: score *= 8.0
                        if tp['owner'] != -1 and tp['ships'] > 50: score *= 0.4
                        if history.get(tp['id'], (0,0))[1] > 0: score *= 3.0 # Revenge bonus
                ...
                if best_t:
                    ...
                    moves.append([mp['id'], best_a, int(send)])
                    avail -= send
